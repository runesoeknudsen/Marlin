...
#define STRING_CONFIG_H_AUTHOR "@rsk" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EFB //This is from the original AnyCube source
#endif
 ...
 */
#define TEMP_SENSOR_0 1 //This is taken from AnyCubic Kossel original firmware 
...
#else
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -15.70 // Z offset: -below +above  [the nozzle]
#endif
